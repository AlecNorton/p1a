...
def main():
    ...
    series = [
        ("Roll", vicon_roll, gyro_roll, accel_roll),
        ("Pitch", vicon_pitch, gyro_pitch, accel_pitch),
        ("Yaw", vicon_yaw, gyro_yaw, accel_yaw),
    ]

    for axis, (name, vicon_angle, gyro_angle, accel_angle) in zip(axes, series):
